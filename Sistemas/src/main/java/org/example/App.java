...
public class App {
    public static void main(String[] args) {
        ...
        pDriver.findElement(By.id("first-name")).sendKeys("John");
        pDriver.findElement(By.id("last-name")).sendKeys("Doe");
        pDriver.findElement(By.id("postal-code")).sendKeys("12345");
